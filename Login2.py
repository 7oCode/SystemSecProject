...
def audit_log(action, user_id=None, username=None, ip_address=None):
    """
    Log sensitive actions for auditing purposes.
    :param action: The action being audited.
    :param user_id: The user ID of the user performing the action (optional).
    :param username: The username of the user performing the action (optional).
    :param ip_address: The IP address of the user performing the action (optional).
    """
    ...
    if ip_address:
        log_msg += f", IP Address: {ip_address}"
